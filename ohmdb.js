...
ga('create', 'UA-45747376-1', 'ohmdb.com');
ga('send', 'pageview');
			...
			.ready(
					function($) {
						...
						var mce_validator = $("#mc-embedded-subscribe-form")
								.validate(options);
						$("#mc-embedded-subscribe-form").unbind('submit');// remove
																			// the
																			// validator
																			// so
																			// we
																			...
																			// validator
						options = {
							url : 'http://ohmdb.us3.list-manage.com/subscribe/post-json?u=c2c27aa25fdef31d9513d6124&id=fdd36fe9b9&c=?',
							type : 'GET',
							dataType : 'json',
